...
//       }
  ...
  private:
    ...
    std::map<std::string,Double_t> b_fjpt_2;
    std::map<std::string,Double_t> b_fjeta_2;
    ...
    std::map<std::string,Double_t> b_m_taub;
    std::map<std::string,Double_t> b_m_taumub;
    std::map<std::string,Double_t> b_m_mub;
