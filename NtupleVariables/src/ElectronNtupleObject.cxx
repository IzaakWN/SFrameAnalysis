...
namespace Ntuple {
  ...
  void ElectronNtupleObject::ConnectVariables( const TString& treeName,
    ...
    if(  ((detail_level & Ntuple::ElectronBoostedIsolation) == Ntuple::ElectronBoostedIsolation)  ) {
      setConnectSucceeded(43, ConnectVariable( treeName, prefix + m_objectNames.getName("SemileptonicPFIso"), SemileptonicPFIso));
      setConnectSucceeded(44, ConnectVariable( treeName, prefix + m_objectNames.getName("SemileptonicCorrPFIso"), SemileptonicCorrPFIso));
