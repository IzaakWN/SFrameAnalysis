...
class RecoilCorrector {
  ...
  public:
    ...
    void Correct( float MetPx, float MetPy, float genZPx, float genZPy, float diLepPx, float diLepPy,
	              int njets, float & MetCorrPx, float & MetCorrPy );

    void CorrectByMeanResolution( float MetPx,   float MetPy,  float genZPx, float genZPy,
			                      float diLepPx, float diLepPy,
			                      int njets, float & MetCorrPx,  float & MetCorrPy );
			                    
    TLorentzVector CorrectByMeanResolution( float MetPx,  float MetPy,  float genVPx, float genVPy,
  ...
  private:
    ...
    void CalculateU1U2FromMet( float MetPx, float MetPy, float genZPx,  float genZPy, float diLepPx,  float diLepPy,
...
class RecoilCorrectorTool : public SToolBase {
  ...
  public:
    ...
    // PF MET
    TLorentzVector CorrectPFMETByMeanResolution( float MetPx,  float MetPy,  float genVPx, float genVPy,
					                             float visVPx, float visVPy, int njets);
	
	// MVA MET
    TLorentzVector CorrectMVAMETByMeanResolution( float MetPx,  float MetPy,  float genVPx,   float genVPy,
					                              float visVPx, float visVPy, int njets );
